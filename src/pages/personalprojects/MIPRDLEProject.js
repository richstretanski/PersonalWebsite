const MIPRDLEProject = () => {
  return (
    <div id="ppcontent">
      <span id="14" className="papers"><a href="https://richtheinvincible.github.io/MIPRDLE/" target="_blank" rel="noopener noreferrer">MIPR Daily Puzzle (MIPRDLE)</a></span>
      <br />
      <br />
      <p>
      ...
      <p>
        ...
        <ul className="courses">
          ...
          <li>Start with the PR season and unlock additional hints with each guess.</li>
